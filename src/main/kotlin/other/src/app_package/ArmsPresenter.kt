...
import ${provider.appPackageName.value}.mvp.ui.base.BaseMoulePresenter
import  ${provider.modelPackageName.value}.${provider.pageName.value}Model
import ${provider.contractPackageName.value}.${provider.pageName.value}Contract

class ${provider.pageName.value}Presenter : BaseMoulePresenter<${provider.pageName.value}Contract.Model, ${provider.pageName.value}Contract.View>()  {
    override fun createModel(): ${provider.pageName.value}Contract.Model {
        return ${provider.pageName.value}Model()
    }
}
"""
